...
<head>
	...
	<link type="text/css" rel="stylesheet/less" href="${duobei_styles}/less/group_detail.less">
	...
	<duobei:script type="text/javascript" src="less-1.3.0.min.js" charset="utf-8" display="false"/>
</head>
				...
				<div class="group_detail_wrap cf">
					<div class="group_info fl">
						...
						<div class="nickname_and_member fl">
							<h3>${groupDetailVO.groupInfoVO.title}</h3>
